...
@Component({
  selector: 'app-xemcthoadon',
  templateUrl: './xemcthoadon.component.html',
  styleUrls: ['./xemcthoadon.component.css']
})
export class XemcthoadonComponent extends BaseComponent implements OnInit,AfterViewInit  {
